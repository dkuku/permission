defmodule Web.Telemetry do
  ...
  def metrics do
    [
      ...
      summary("workpermit.repo.query.total_time", unit: {:native, :millisecond}),
      summary("workpermit.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("workpermit.repo.query.query_time", unit: {:native, :millisecond}),
      summary("workpermit.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("workpermit.repo.query.idle_time", unit: {:native, :millisecond}),
